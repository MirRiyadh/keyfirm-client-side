        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="text-center md:text-left mb-4 lg:pt-16">
            ...
            <button>
              <Link
                href="#_"
                class="relative inline-flex items-center justify-start px-10 py-3 overflow-hidden font-medium transition-all bg-sky-500 rounded-xl group"
              >
                <span class="absolute top-0 right-0 inline-block w-4 h-4 transition-all duration-300 ease-in-out bg-sky-700 rounded group-hover:-mr-4 group-hover:-mt-4">
                  <span class="absolute top-0 right-0 w-5 h-5 rotate-45 translate-x-1/2 -translate-y-1/2 bg-white"></span>
                </span>
                <span class="absolute bottom-0 left-0 w-full h-full transition-all duration-200 ease-in-out delay-200 -translate-x-full translate-y-full bg-sky-700 rounded-2xl group-hover:mb-12 group-hover:translate-x-0"></span>
