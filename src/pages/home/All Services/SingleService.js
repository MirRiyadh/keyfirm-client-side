        ...
        <div className="bg-white shadow-xl lg:w-[300px] lg:h-[420px] 2xl:w-[320px] 2xl:h-[400px] relative lg:top-[-50px] 2xl:top-[-30px] left-5 border">
          <div className="w-10/12 m-auto mt-16">
            ...
            <button className="py-5">
              <a
                href="#_"
                class="relative inline-flex items-center justify-start py-2 pl-4 pr-12 overflow-hidden font-semibold text-sky-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-gray group"
              >
                <span class="absolute bottom-0 left-0 w-full h-[2px] transition-all duration-150 ease-in-out bg-sky-800 group-hover:h-full"></span>
